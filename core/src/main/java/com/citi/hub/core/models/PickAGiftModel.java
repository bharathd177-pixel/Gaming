...
public class PickAGiftModel {
    ...
    public String getTitle() {
        return title != null ? title : "Pick Your Prize!";
    }

    public String getButtonText() {
        return buttonText != null ? buttonText : "🎁 PICK A GIFT";
    }

    public String getModalTitle() {
        return modalTitle != null ? modalTitle : "Pick Your Prize!";
    }

    public String getModalSubtitle() {
        return modalSubtitle != null ? modalSubtitle : "Choose one of the gift boxes below to reveal your prize!";
    }
    ...
    public String getPlayButtonText() {
        return playButtonText != null ? playButtonText : "PLAY NOW";
    }
