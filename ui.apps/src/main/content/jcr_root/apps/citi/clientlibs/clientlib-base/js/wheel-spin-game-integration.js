...
console.log('🚀 WHEEL SPIN GAME SCRIPT STARTING TO LOAD...');
window.wheelSpinGameScriptLoaded = true;

(function() {
    'use strict';

    console.log('🔧 WHEEL SPIN GAME SCRIPT EXECUTING...');
    ...
    setTimeout(() => {
        ...
        if (container && !container.dataset.initialized) {
            container.innerHTML = '<div style="position: fixed; bottom: 100px; right: 20px; background: red; color: white; padding: 10px; border-radius: 5px; z-index: 9999;">🔧 Script Loaded - Initializing...</div>';
        }
    }, 1000);
    
    console.log('✅ WHEEL SPIN GAME SCRIPT COMPLETED SUCCESSFULLY');
    
    } catch (error) {
        console.error('❌ WHEEL SPIN GAME SCRIPT ERROR:', error);
        ...
        setTimeout(() => {
            ...
            if (container) {
                container.innerHTML = '<div style="position: fixed; bottom: 100px; right: 20px; background: red; color: white; padding: 10px; border-radius: 5px; z-index: 9999;">❌ Script Error: ' + error.message + '</div>';
            }
        }, 1000);
    }
